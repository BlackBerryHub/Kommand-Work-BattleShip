...
public class MainMenu {
	...
	public void loadTitleScreen() {
		...
		bkgImageContainer.setLocation(0, 25);
		bkgImageContainer.setVisible(true);
		
		errorMessage = new JLabel("Помилка: сітка занадто маленька, щоб відповідати вибранним кораблям");
		...
		startGame = new JButton("Старт Гри");
		...
		gridSizeBtn = new JButton("Ширина Сітки: " + GameLogic.boardSize);
		...
		gridSizeBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				gridSizeBtn.setText("Ширина Сітки: " + GameLogic.boardSize);
		...
		battleshipSize = new JButton("Довжина Лінкорна: " + GameLogic.battleshipSize);
		...
		battleshipSize.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				battleshipSize.setText("Довжина Лінкорна: " + GameLogic.battleshipSize);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
		...
		battleshipCount = new JButton("Кількість Лінкорнів: " + GameLogic.battleshipCount);
		...
		battleshipCount.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				battleshipCount.setText("Кількість Лінкорнів: " + GameLogic.battleshipCount);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
		...
		cruiserSize = new JButton("Довжина Крейсера: " + GameLogic.cruiserSize);
		...
		cruiserSize.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				cruiserSize.setText("Довжина Крейсера: " + GameLogic.cruiserSize);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
		...
		cruiserCount = new JButton("Кількість Крейсерів: " + GameLogic.cruiserCount);
		...
		cruiserCount.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				cruiserCount.setText("Кількість Крейсерів: " + GameLogic.cruiserCount);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
		...
		destroyerSize = new JButton("Довжина Есмінця: " + GameLogic.destroyerSize);
		...
		destroyerSize.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				destroyerSize.setText("Довжина Есмінця: " + GameLogic.destroyerSize);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
		...
		destroyerCount = new JButton("Кількість Есмінців: " + GameLogic.destroyerCount);
		...
		destroyerCount.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				destroyerCount.setText("Кількість Есмінців: " + GameLogic.destroyerCount);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
		...
		submarineSize = new JButton("Довжина Судмарини: " + GameLogic.submarineSize);
		...
		submarineSize.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				submarineSize.setText("Довжина Судмарини: " + GameLogic.submarineSize);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
		...
		submarineCount = new JButton("Кількість Судмарин: " + GameLogic.submarineCount);
		...
		submarineCount.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				submarineCount.setText("Кількість Судмарин: " + GameLogic.submarineCount);
				boolean shipsFit = canShipsFitOnBoard();
				startGame.setEnabled(shipsFit);
				errorMessage.setVisible(!shipsFit);
			}	
